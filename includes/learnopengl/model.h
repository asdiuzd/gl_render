...
private:
    void merge_meshes() {
        ...
        for (auto &mesh : meshes) {
            ...
            new_mesh.vertices.insert(new_mesh.vertices.end(), mesh.vertices.begin(), mesh.vertices.end());
            new_mesh.indices.insert(new_mesh.indices.end(), idxs.begin(), idxs.end());
            new_mesh.textures.insert(new_mesh.textures.end(), mesh.textures.begin(), mesh.textures.end());
            sum += mesh.vertices.size();
        }
        new_mesh.SetupMeshAfterInitialize();
        meshes.clear();
